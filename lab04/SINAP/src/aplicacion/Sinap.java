...
public class Sinap{
    ...
    public void adicione(String nombre, String name,String ubicacion, String area, String descripcion) throws SINAPExcepcion{
	   if("".equals(name))
	   {
		   throw new SINAPExcepcion(SINAPExcepcion.AREA_NULA);
	   }
	   //System.out.println(getDetalles(nombre,name));
	   if(getDetalles(nombre,name)!=null)
	   {
		   throw new SINAPExcepcion(SINAPExcepcion.AREA_REPETIDA);
	   }
	   //System.out.println(Integer.parseInt(area));
	   if(Integer.parseInt(area)<0)
	   {
		   throw new SINAPExcepcion(SINAPExcepcion.AREA_INVALIDA);
	   }	   
    ...
    public ArrayList<Area> busque(String prefijo){
		ArrayList<Area> resultados=new ArrayList<Area>();//new ArrayList<Area>();
