...
public class CheckersTest
{
    ...
    {
        Checkers checkers1 = new Checkers(8);
        checkers1.add(false, 2, 3,"blue");
        checkers1.swap();
        checkers1.add(true , 4, 7,"blue");
        checkers1.select(2, 3);
        checkers1.move("left");
        checkers1.swap();
        checkers1.add(true, 3, 4,"blue");
        checkers1.add(false, 4, 5,"blue");
        checkers1.swap();
